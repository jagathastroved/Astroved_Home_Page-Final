...
const SOLUTIONS: SolutionItem[] = [
  ...
  },
  {
    ...
    link: "/us/specials/astrology-products?promo=SL_Energized_Products-2",
    isExternal: true
  },
  {
    id: 3,
    ...
    link: "/trip-c414.aspx?promo=SL_trip-3",
    isExternal: true
  }
];
...
const DESKTOP_IMG_WRAPPER_STYLES = "w-full h-64 lg:h-72 relative isolate";
const DESKTOP_CARD_CONTENT_STYLES = "px-5 lg:px-8 pb-4 lg:pb-0 pt-2 flex flex-col flex-grow z-10 relative";
...
const MOBILE_DESKTOP_IMG_OVERLAY_STYLES = "hidden lg:block absolute top-0 bottom-0 left-0 w-[55%] pointer-events-none p-2 lg:p-2.5";
const MOBILE_IMG_WRAPPER_STYLES = "lg:hidden absolute top-0 inset-x-0 h-[240px] pointer-events-none p-2";
const MOBILE_GRADIENT_OVERLAY_STYLES = "hidden"; // Not used anymore, kept for variable definition just in case
const MOBILE_CONTENT_CONTAINER_STYLES = "w-full lg:w-[45%] ml-auto px-6 pb-20 pt-[270px] sm:px-12 lg:p-16 flex flex-col justify-center items-center lg:items-start text-center lg:text-left z-10 relative h-full lg:mt-0 lg:pt-0";
