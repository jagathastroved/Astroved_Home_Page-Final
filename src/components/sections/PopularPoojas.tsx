...
import { 
  ChevronLeft, ChevronRight, ArrowRight, ShieldCheck, UserCheck, Lock, HeadphonesIcon, Flower2
} from 'lucide-react';
                ...
                <div key={item.id} className="pl-4 min-w-[260px] sm:min-w-[280px] md:min-w-[300px] lg:min-w-[280px] xl:min-w-[300px] max-w-[320px] flex-[0_0_100%] sm:flex-[0_0_50%] lg:flex-[0_0_20%]">
                  <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-200 dark:border-slate-700 transition-all duration-300 flex flex-col h-full transform lg:hover:-translate-y-1 group">
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      <h3 className="font-serif text-[18px] font-bold text-[#2d2d2d] dark:text-white mb-4 leading-snug line-clamp-2">
                        {item.title}
                      </h3>
                      
                      <p className="font-sans text-[14px] text-gray-500 dark:text-gray-400 mb-3 line-clamp-2 leading-relaxed">
                        {item.description}
                      </p>
                      ...
                      <div className="mt-auto space-y-3 mb-5">
                        <div className="flex items-start text-[13px] text-gray-500 dark:text-gray-400 font-medium">
                          ...
                          <span className="leading-tight">{item.benefit1}</span>
                        </div>
                        <div className="flex items-start text-[13px] text-gray-500 dark:text-gray-400 font-medium">
                          <UserCheck className="w-4 h-4 mr-2 text-amber-500 flex-shrink-0 mt-0.5" />
                          <span className="leading-tight">{item.benefit2}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between mb-4 border-t border-gray-100 dark:border-slate-700/50 pt-4">
                        ...
                        <div className="flex items-baseline">
                          <span className="text-xl font-bold text-[#D65324] dark:text-amber-500">₹{item.price}</span>
                        </div>
                      </div>
